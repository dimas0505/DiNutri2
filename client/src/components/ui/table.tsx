...
>(({ className, ...props }, ref) => (
  <tbody
    ref={ref}
    className={cn("[&_tr:last-child]:border-0 [&_tr:hover]:bg-muted/20 transition-colors", className)}
    {...props}
  />
))
...
>(({ className, ...props }, ref) => (
  <tr
    ref={ref}
    className={cn(
      "border-b border-border transition-all duration-150 hover:bg-muted/30 data-[state=selected]:bg-primary/5",
      className
    )}
    {...props}
  />
