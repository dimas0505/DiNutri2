            ...
            <div className="pt-2">
              ...
              <div className="grid grid-cols-2 gap-2">
                {[
                  ...
                  { label: "Ombros", value: latestAnthro.circumShoulders, unit: "cm" },
                  ...
                  { label: "Braço D.", value: latestAnthro.circumRightArm, unit: "cm" },
                  { label: "Braço E.", value: latestAnthro.circumLeftArm, unit: "cm" },
                  { label: "Coxa D.", value: latestAnthro.circumRightThigh, unit: "cm" },
                  { label: "Coxa E.", value: latestAnthro.circumLeftThigh, unit: "cm" },
                  { label: "Panturrilha D.", value: latestAnthro.circumRightCalf, unit: "cm" },
                  { label: "Panturrilha E.", value: latestAnthro.circumLeftCalf, unit: "cm" },
