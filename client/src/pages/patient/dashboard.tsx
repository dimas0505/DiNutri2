    ...
    <MobileLayout hideHeader>
      <div className="min-h-screen bg-[#F0F1F7] pb-24">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <h1 className="text-[2rem] font-bold leading-tight">{(user as any)?.firstName || "Paciente"}</h1>
              </div>
            </div>
        ...
        <section className="px-5 pt-5">
          <h2 className="text-[2rem] font-bold text-[#252638]">Menu do Paciente</h2>
          <p className="text-lg text-[#6C7282] mt-1">Acesse suas informações e acompanhe sua evolução</p>
            ...
            {dashboardCards.map((card) => {
              ...
              return (
                <button
                  ...
                  className="bg-white rounded-2xl px-3 py-4 min-h-[152px] border border-[#E9E9EF] shadow-[0_2px_8px_rgba(12,12,13,0.04)] flex flex-col items-center justify-center text-center"
                >
                  ...
                  <h3 className="mt-3 text-[1.35rem] font-bold text-[#272838] leading-tight">{card.title}</h3>
                  <p className="mt-1 text-sm text-[#6B7280] leading-snug">{card.subtitle}</p>
                </button>
              );
            })}
          </div>
