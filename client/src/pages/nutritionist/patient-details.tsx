                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="mt-2 flex flex-wrap gap-x-4 gap-y-1 text-xs text-muted-foreground">
                        ...
                        {(() => {
                          ...
                          const equation = (assessment.conversionEquation as "siri" | "brozek") || (nutritionistSettings?.bodyFatEquation || "siri") as "siri" | "brozek";
                ...
                {(() => {
                  ...
                  return (
                    <>
                      ...
                      <h4 className="font-semibold text-muted-foreground uppercase text-xs tracking-wide mb-3">Análise da Composição Corporal</h4>
