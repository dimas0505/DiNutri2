  ...
  return (
    <div className="px-4 py-4 md:px-0 md:py-0 space-y-4">
      <div className="flex items-center justify-between gap-2">
        <div>
          <h1 className="text-2xl md:text-3xl font-bold">Relatório de Notificações</h1>
          <p className="text-sm text-muted-foreground">Acompanhe adesão e alcance das notificações.</p>
        </div>
        <Link href="/reports">
